...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-8 col-xs-7">
			...
			<div class="row" style="margin-top: 20px;">
				<div class="col-md-2 col-xs-3">
					<div class="row text-center"><img src="<%=basePath %>upload/NoImage.jpg" style="border: none;width:60px;height:60px;border-radius: 50%;" /></div>
					<div class="row text-center" style="margin: 5px 0px;">王小明</div>
				</div>
				<div class="col-md-7 col-xs-5">你啊干辣椒发啦发了个安澜</div>
				<div class="col-md-3 col-xs-4" >2017-11-21 14:15:22</div>
			</div>
			<div class="row" style="margin-top: 20px;">
				<div class="col-md-2 col-xs-3">
					<div class="row text-center"><img src="<%=basePath %>upload/NoImage.jpg" style="border: none;width:60px;height:60px;border-radius: 50%;" /></div>
